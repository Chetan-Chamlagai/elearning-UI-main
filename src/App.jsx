...
import TeacherExamManagement from "./teacher/pages/TeacherExamManagement";
import TeacherLiveClassManagement from "./teacher/pages/TeacherLiveClassManagement";
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={["Role_TEACHER"]} />}>
            <Route path="/teacher" element={<TeacherLayout />}>
              ...
              <Route path="live-classes" element={<TeacherLiveClassManagement />} />
