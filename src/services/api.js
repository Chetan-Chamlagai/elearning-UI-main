import axios from 'axios'
  ...
  api.post(`/users/file/upload/${userId}`, formData),
};
...
export const paymentService = {
 ...
 export const liveClassService = {
  ...
  getByUserId: (userId, config) =>
    api.get(`/lives/user/${userId}`, config),
...
export const examService = {
  ...
  getExamByUserAndFaculty: (userId, faculty) =>
    api.get(
      `/exams/user/${userId}/faculty/${encodeURIComponent(faculty)}`
    ),
